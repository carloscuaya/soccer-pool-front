        ...
        <div className="bg-background text-on-surface min-h-screen selection:bg-secondary-container selection:text-on-secondary-container">
            ...
            <header className="fixed top-0 w-full flex justify-between items-center px-8 py-6 z-50">
                ...
                <div className="hidden md:flex items-center gap-6">
                    <a className="text-sm font-semibold text-secondary hover:text-primary transition-colors" href="#">Support</a>
                    <a className="text-sm font-semibold text-secondary hover:text-primary transition-colors" href="#">Documentation</a>
                </div>
            </header>
                    ...
                    <div className="hidden lg:flex flex-col space-y-8 text-left">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="p-6 rounded-3xl bg-surface-container-lowest shadow-[0_32px_64px_-15px_rgba(186,234,255,0.4)] border border-white/50 backdrop-blur-sm">
                                ...
                                <h3 className=" font-bold text-on-surface">Live Stats</h3>
                            ...
                            <div className="p-6 rounded-3xl bg-surface-container-lowest shadow-[0_32px_64px_-15px_rgba(186,234,255,0.4)] border border-white/50 backdrop-blur-sm">
                                ...
                                <h3 className=" font-bold text-on-surface">Tactical Hub</h3>
                    ...
                    <div className="flex flex-col items-center lg:items-end">
                        <div className="w-full max-w-md p-10 lg:p-12 rounded-[40px] bg-surface-container-lowest/80 backdrop-blur-2xl shadow-[0_40px_80px_-20px_rgba(0,31,41,0.08)] border border-white">
                            <div className="mb-10 text-center lg:text-left">
                                <h2 className=" font-extrabold text-4xl text-on-surface tracking-tight mb-2">Match Control</h2>
                                <p className="text-on-surface-variant font-medium">Enter your credentials to enter the arena.</p>
                            </div>
                            <form onSubmit={handleLogin} className="space-y-6">
                                <div className="space-y-2">
                                    <label className="block text-xs font-bold text-secondary uppercase tracking-widest ml-1" htmlFor="username">Username</label>
                                    <div className="relative">
                                        ...
                                        <input className="w-full pl-12 pr-4 py-4 rounded-2xl bg-surface-container-low border-0 border-b-2 border-transparent focus:border-primary focus:ring-0 transition-all text-on-surface placeholder:text-outline" id="username" name="username" placeholder="username" type="text" value={username} onChange={(e) => setUsername(e.target.value)} />
                                    </div>
                                </div>
                                <div className="space-y-2">
                                    <div className="flex justify-between items-center px-1">
                                        <label className="block text-xs font-bold text-secondary uppercase tracking-widest" htmlFor="access-key">Access Key</label>
